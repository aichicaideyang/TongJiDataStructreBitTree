...
#include <QDebug>
#include <math.h>
ShowUserFriendWindow::ShowUserFriendWindow(QString now_user,QSet<QString> &friends)
{
    this->setFixedSize(800,640);
    setWindowIcon(QIcon(":/src/Icon.png"));
    setWindowTitle(QString("用户:%1 好友图").arg(now_user));
    this->friends=friends;
    MapButton *center_btn=new MapButton(this->width(),this->height()*.1,now_user,1);
...
void ShowUserFriendWindow::paintEvent(QPaintEvent *)
{
